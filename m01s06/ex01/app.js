...
const car = {
  ...
  setSpeed: function (input) {
    if (input <= this.topSpeed && input >= this.topReverseSpeed) {
      this.speed = input;
    } else {
      console.warn(`car can't vroom vroom that fast`);
    }
  },
};
...
console.log(
  `Masina este marca ${car.make} si se deplasa cu ${car.speed} km/h.`,
);
